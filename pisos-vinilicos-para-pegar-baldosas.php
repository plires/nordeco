...
<html lang="es">
	...
	<head>
		...
		<meta charset="utf-8">
		<title>Nordeco, pisos vinilicos sistema para pegar - Baldosas</title>
		<meta name="description" content="Pisos vinilicos flotantes con sistema de pegar. Baldosas">
		...
		<div class="page-wrapper">
			...
			<section class="container">
				<div class="col-sm-12 text-center">
					...
					<h2 class="light">SISTEMA PARA PEGAR - BALDOSAS</h2>
				</div>
			</section>
			...
			<div class="container">
				<section class="row">
					<div class="col-sm-12">
						<h2>PISOS VINÍLICOS SISTEMA PARA PEGAR - BALDOSAS</h2>
						<div class="separator-2"></div>
					</div>

					<?php 
						$query = $db->prepare("SELECT * FROM pisos WHERE observaciones = 'Sistema para Pegar' AND linea = 'baldosas'");
						$query->execute();
