...
<html lang="es">
    ...
    <?php include_once("../includes/tag_manager_head.inc") ?>
	  ...
	  <meta name="description" content="pisos flotantes flotantes con sistema de encastre tipo click sin adhesivos.">
    ...
    <!-- Normalize CSS -->
	  ...
	  <title>Pisos Flotantes - Sistema click sin adhesivo</title>
	...
	<body>
			...
			<div class="row">
	          ...
	          <div class="text-center">
	            ...
	            <p class="parrafo_descripcion_linea wow fadeInUp">CONSULTANOS LA MEJOR FINANCIACIÓN</p>
			    	...
			    	<input name="origin" type="hidden" value="Landing Pisos Flotantes">

					  <div class="form-group">
					    <input required name="name" type="text" class="form-control" placeholder="Ingresá tu nombre" value="<?= $name ?>">
					  </div>

					  <div class="form-group">
					    <input required name="email" type="email" class="form-control" placeholder="Ingresá tu email" value="<?= $email ?>">
					  </div>

					  <div class="form-group">
					    <input required name="phone" type="tel" class="form-control" placeholder="Ingresá tu teléfono" value="<?= $phone ?>">
					  </div>

					  <textarea required class="form-control" name="comments" rows="3" placeholder="Que necesitás?"><?= $comments ?></textarea>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-7 col-sm-12 wow fadeIn datos_linea">
						...
						<h1>LÍNEA <br><strong>PISOS FLOTANTES</strong></h1>
						<img class="mb_15" src="img/pisoplast.png" alt="pisos flotantes pisoplast">
		...
		<section class="container-fluid showrooms">
			...
			<div class="row">
				<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 text-center">
					<h2 class="h2_showrooms wow fadeInLeft">AHORA YA PODES VISITARNOS EN NUESTROS SHOWROOMS DE NORDELTA Y SAN MARTIN</h2>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 wow fadeInUp nordelta">
					<div class="mapa">
						<iframe style="height:100%; min-height: 435px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3291.660118577659!2d-58.63150888436345!3d-34.4099838805101!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccac8632d0a23%3A0x3711744313aae8a4!2sUrban%20Storage%20Nordelta%20-%20Bauleras%20y%20guardamuebles!5e0!3m2!1ses-419!2sar!4v1571685748990!5m2!1ses-419!2sar" width="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
					</div>
				...
				<div class="col-lg-6 wow fadeInUp">
					<div class="mapa">
						<iframe style="height:100%; min-height: 435px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3284.9059995397247!2d-58.548108184359705!3d-34.58124498046546!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcb779a0e3d0ff%3A0x46d82ea5a09636a3!2sCalle%2056%204575%2C%20B1650%20Villa%20Lynch%2C%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1571682044210!5m2!1ses-419!2sar" width="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
					</div>
					<div class="datos_mapa">
						<img class="img-fluid" src="img/icon-localization.png" alt="google maps en nordelta">
			...
			<div class="row mb_60">
				<div class="col-md-8 offset-md-2 text-center mb_60">
					<h2 class="h2_encabezado wow fadeInLeft">
						...
						comerciales y domésticos. <br><strong>Desarrollados con materiales de primera calidad.</strong> Aptos alto tránsito.
					</h2>
				</div>
		...
		<section class="container colores mb_60">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/gris-castor.jpg" alt="pisos flotantes color Gris castor">
					<h4>Piso Flotante - Gris Castor</h4>
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/gris-veta.jpg" alt="pisos flotantes color Gris Veta">
					<h4>Piso Flotante - Gris Veta</h4>
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1323</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1132 <span class="m2">+ iva x m2</span></p> -->
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/vison-castor.jpg" alt="pisos flotantes color vison castor">
					<h4>Piso Flotante - Visón Castor</h4>
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1323</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1132 <span class="m2">+ iva x m2</span></p> -->
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/roble-americano.jpg" alt="pisos flotantes color Roble Americano">
					<h4>Piso Flotante - Roble Americano</h4>
					<div class="precios wow fadeIn">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/maple.jpg" alt="pisos flotantes color Maple">
					<h4>Piso Flotante - Maple</h4>
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft precio_promo">$1132</p> -->
						<!-- <span class="precio_promo">+ iva x m2</span> -->
						<p class="vigencia">* Consultar Stock</p>
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/nogal.jpg" alt="pisos flotantes color Nogal">
					<h4>Piso Flotante - Nogal</h4>
					<div class="precios wow fadeIn">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/caoba.jpg" alt="pisos flotantes color vison Caoba">
					<h4>Piso Flotante - Visón Caoba</h4>
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1323</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1132 <span class="m2">+ iva x m2</span></p> -->
			...
			<div class="row">
				<div class="col-md-8 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/medida-liston.jpg" alt="piso flotantes medida listones">
				</div>
		...
		<section class="container colores mb_60">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/marfil.jpg" alt="pisos flotantes color Marfil">
					<h4>Piso Flotante - Marfil</h4>
					<div class="precios wow fadeIn">
				...
				<div class="col-md-6 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/cemento.jpg" alt="pisos flotantes color Cemento">
					<h4>Piso Flotante - Cemento</h4>
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1230</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1149 <span class="m2">+ iva x m2</span></p> -->
				...
				<div class="col-md-8 text-center mb_30">
					<img class="img-fluid wow fadeInUp" src="img/medida-baldosa.jpg" alt="piso flotantes medida baldosas">
				</div>
		...
		<section class="container colores mb_60">
			...
			<div class="row">
				<div class="col-md-6 text-center mb_30">
					<img class="img_click img-fluid wow fadeInUp" src="img/encastre-click.jpg" alt="piso flotantes medida baldosas">
				</div>
				<div class="col-md-6 mb_30 wow fadeInLeft align_vertical_horizontal">
					<div>
						<h4>PISOS FLOTANTES CON TECNOLOGÍA DE ENCASTRE CLICK</h4>
						<p>
		...
		<section class="container aplicaciones mb_60">
			...
			<div class="row">
				...
				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/facil-instalar.gif" alt="pisos flotantes facil lavado">
					<p class="aplicaciones_parrafo">Fácil de instalar, limpiar y mantener.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/resistente-aranazos.gif" alt="pisos flotantes resistentes a los arañazos">
					<p class="aplicaciones_parrafo">Resistente a golpes y arañazos.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/sin-quimicos.gif" alt="pisos flotantes no requiere productos quimicos">
					<p class="aplicaciones_parrafo">No requiere de productos químicos agresivos para su limpieza.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/superficies-existentes.gif" alt="pisos flotantes sobre superficies existentes">
			...
			<div class="row">
				...
				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/resistente-agua.gif" alt="pisos flotantes resistentes al agua">
					<p class="aplicaciones_parrafo">Resistente 100% al agua, ideal en baños y cocinas.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/materiales-reciclados.gif" alt="pisos flotantes materiales reciclados">
					<p class="aplicaciones_parrafo">Fabricado con materiales reciclados.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/aislamiento-acustico.gif" alt="pisos flotantes aislamiento acustico">
					<p class="aplicaciones_parrafo">Aislamiento acústico y térmico, ideal para pisos radiantes.</p>
				</div>

				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/antideslizante.gif" alt="pisos flotantes antideslizantes">
