...
<?php
	...
	if (isset($_POST['send'])){
		...
		if (count($errors) === 0){
			...
			$send = $app->sendEmail($_POST, 'cliente', 'Presupuesto Pisos Flotantes');
    ...
    <div class="row">
      ...
      <div class="col-md-3 text-center">
        <img class="mb_15 wow fadeInUp" src="img/resistente-aranazos.gif"
          alt="pisos flotantes resistentes a los arañazos">
      ...
      <div class="col-md-3 text-center">
        <img class="mb_15 wow fadeInUp" src="img/superficies-existentes.gif"
          alt="pisos flotantes sobre superficies existentes">
