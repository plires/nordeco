...
<body>
  ...
  <header class="container">
    <div class="row">
      ...
      <div class="col-md-6 wow fadeIn header_datos hidden_phone">
        ...
        <!-- Whatsapp -->
        <div class="whatsapp">
          <a href="https://api.whatsapp.com/send?phone=5491153117118&text=Hola!%20Necesito%20hacer%20una%20consulta!"
            target="_blank">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 wow fadeIn">
          <div class="faja">
            <h1>LÍNEA <br> <span class="font-weight-bold">ENVIO EXITOSO</span></h1>
            <h2>
              Gracias por tu contacto. Nos comunicaremos a la brevedad posible.
            </h2>
          </div>
        </div>
  ...
  <section class="faja_mobile container-fluid text-center">
    ...
    <div class="row">
      <div class="col-sm-12">
        <p>
          Fabricados con tubo estructural de aluminio anodizado, son resistentes a la interperie y no necesitan
          mantenimiento.
        </p>
      </div>
    </div>
  ...
  <!-- CARACTERISTICAS -->
  <section class="container mb-5 section_caracteristicas gracias_caracteristicas">

    <div class="row mb-3">
      <div class="col-md-8 offset-md-2 wow fadeInLeft text-center">
        <p>
          Nuestros muebles de exterior o muebles de jardín están fabricados en una aleación de aluminio especial,
          mediante un proceso de anodizado crea un material que no se daña y es inoxidable. <strong>Su acabado es suave
            y uniforme.</strong>
        </p>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="wow fadeInUp">
            Ofrecemos soluciones integrales de mobiliarios para amenities, sum de edificios, torres, hoteles, countries
            y empresas. <strong>Ponemos a su alcance las últimas tendencias en diseño y calidad.</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-4 col-sm-6 text-center mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="index.php" class="btn btn_site toForm transition">CONSULTAR</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Reposeras con las últimas tendencias del diseño. Comenzá a disfrutar del sol y tu
              piscina.</p>
            <a href="index.php" class="btn btn_site toForm transition">CONSULTAR</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Reposera tipo tijera para tus tardes de verano. Excelente postura, gran terminación.
            </p>
            <a href="index.php" class="btn btn_site toForm transition">CONSULTAR</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Mesas para exterior. Ámplias y súper cómodas. Ideales para compartir comidas al aire
              libre.</p>
            <a href="index.php" class="btn btn_site toForm transition">CONSULTAR</a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="wow fadeInUp">
            ...
            Gracias a la tecnología de su construcción, son libres de mantenimiento a diferencia de otros muebles de
            exterior en materiales como madera, rattan o plástico, <strong>no se deterioran en la intemperie.</strong>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-5">
      <div class="col-md-8 offset-md-2 text-center wow fadeInLeft">
        <p>
          ...
          ligereza y versatilidad. Es un metal reciclable que protege el medio ambiente, posee un bajo consumo
          energético
          y no es tóxico. Es uno de los materiales más adecuados para muebles de exterior (outside furniture) dado que
          se mantiene en buenas condiciones durante años porque <strong>no se oxida y es de fácil
  ...
  <section class="container-fluid bg_gris text-center mb-5">
    <div class="container">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="wow fadeInUp">
            <strong>Gran variedad de telas con diferentes texturas para sus tapizados, todas aptas para permanecer a la
              intemperie.</strong>
          </div>
        </div>
      </div>
  ...
  <section class="container text-center mb-5">
    <div class="row">
      <div class="col-md-12">
        <a href="index.php" class="btn btn_site toForm transition">COTIZAR PRODUCTOS</a>
      </div>
    </div>
  </section>
  <!-- TITULO end -->
      ...
      <div class="row mb_15">
        <div class="col-md-8 offset-md-2 align_vertical_horizontal">
          <div class="transition mail">
            ...
            <a class="toForm" href="mailto:info@nordeco.com.ar"><img src="img/mail.png"
                alt="mail">info@nordeco.com.ar</a>
          </div>
        </div>
      </div>
      <div class="row">
