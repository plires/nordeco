...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f6f6f6;">
  <center style="width: 100%; background-color: #f6f6f6;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
      ...
      <!-- Texto-->
      <tr style="background-color: #6bcdb2;">
      ...
      <!-- Boton : BEGIN -->
      <tr style="background-color: #6bcdb2;">
        <td style="background-color: #6bcdb2; text-align: center; padding: 40px;">
          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener" href="{site}"
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #6bcdb2; display: block; border-radius: 4px;">VER
                  MÁS
                </a>
              </td>
            </tr>
