...
<html lang="es">
    ...
    <!-- Normalize CSS -->
	  ...
	  <title>Pisos Vinílicos - Sistema click sin adhesivo</title>
	...
	<body>
		...
		<header class="container">
			<div class="row">
		      ...
		      <img src="img/logo-nordeco.png" alt="logo nordeco">
				...
				<div class="col-md-6 text-right wow fadeIn header_datos hidden_phone">
		      <a class="transition" href="mailto:info@nordeco.com.ar">info@nordeco.com.ar</a>
				</div>
			</div>
		...
		<section class="container mb_30 formulario_mobile">
			...
			<div class="row">
				<div class="col-md-12">
					<img class="img-fluid wow fadeInLeft" src="img/pisos-mobile-promo.jpg">
					<div class="text-center">
						<h1 class="wow fadeIn mb-1">LÍNEA <br><strong>PISOS VINÍLICOS</strong></h1>
						<img style="width: 50%;" class="wow fadeIn mb-4 mt-1" src="img/pisoplast-mobile.gif" alt="pisoplast mobile">
					</div>
						<h4>Consulta esta oferta de pisos vinílicos solo por tiempo limitado o hasta agotar stock</h4>
					<hr>

					<div class="mb_30">
	          <h3 class="h3_paga_cuotas wow fadeInUp mb_30">PAGÁ EN CUOTAS CON TARJETA DE CRÉDITO</h3>
	          <div class="text-center">
	            <img class="img-fluid wow fadeInLeft mb_30" src="img/tarjetas-con-mp.png" alt="tarjetas">
	            <p class="parrafo_descripcion_linea wow fadeInUp">CONSULTANOS LA MEJOR FINANCIACIÓN</p>
			    	...
			    	<input name="origin" type="hidden" value="Landing Pisos Vinilicos Ofertas">
		...
		<section class="container-fluid header_img mb_60 formulario_escritorio">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-7 col-sm-12 wow fadeIn datos_linea">
						<div class="text-left">
							<img style="width: 20%;" class="header_garantia wow fadeInUp" src="img/sistema-click.png" alt="sistema click">
						</div>
						<h1>LÍNEA <br><strong>PISOS VINÍLICOS</strong></h1>
						<img style="width: 30%;" class="mb_15" src="img/pisoplast.png" alt="pisos vinilicos pisoplast">
						<h2 class="h2_oferta"><span>¡OFERTA!</span> ¡SÓLO HASTA <span>AGOTAR STOCK!</span></h2>
						<h4>Consulta esta <strong>OFERTA DE PISOS VINÍLICOS</strong> solo por tiempo limitado</h4>
						<div class="medios_pago wow fadeInLeft">
              <h3>PAGÁ EN CUOTAS <br><span class="bold">CON TARJETA DE CRÉDITO</span></h3>
              <div class="text-center">
                <img class="wow fadeIn" src="img/tarjetas-con-mp.png" alt="tarjetas">
		...
		<section class="container mb_60">
			...
			<div class="row mb_30">
				<div class="col-md-12 text-center">
					<h2 class="h2_aprovecha wow fadeInUp">Aprovechá esta oferta especial: <br>Pisos Vinilicos de Alto Transito <br><span>es por tiempo limitado</span></h2>
					<p class="wow fadeInUp">
						* Oferta válida hasta agotar stock. <br>
		...
		<section class="container colores mb_60">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					...
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1260</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1079 <span class="m2">+ iva x m2</span></p> -->
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					...
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft precio_promo">$1079</p> -->
		...
		<section class="container colores mb_60">
			...
			<div class="row mb_60">
				...
				<div class="col-md-6 text-center mb_30">
					...
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1170</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1095 <span class="m2">+ iva x m2</span></p> -->
				...
				<div class="col-md-6 text-center mb_30">
					...
					<div class="precios wow fadeIn">
						<!-- <p class="wow fadeInLeft tacha_precio_viejo">$1170</p> -->
						<!-- <p class="wow fadeInLeft precio_promo">$1095 <span class="m2">+ iva x m2</span></p> -->
						<span>Disponible <span class="font-weight-bold">45 Cajas</span><br> (cajas de 2.5 m2)</span>
						<p class="vigencia">* Válido hasta agotar stock</p>
					</div>
					<p class="aplicaciones_parrafo wow fadeInUp">>366 Cm x 14 Cm <br>4 mm espesor</p>
					<a class="btn-primary btn_comprar transition wow fadeIn" href="#formulario">COTIZAR</a>
		...
		<section class="container colores mb_60">
			...
			<div class="row">
				...
				<div class="col-md-6 mb_30 wow fadeInLeft align_vertical_horizontal">
					<div>
						<h4>PISOS VINÍLICOS PISOPLAST CON TECNOLOGÍA DE ENCASTRE CLICK</h4>
						<p>
							El sistema de encastre Piso Click permite una colocación 
		...
		<!-- FRANJA NARANJA -->
		<section class="container-fluid franja_naranja mb_60">
			<div class="container">
				<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-12 wow fadeInLeft align_vertical">
					<p>
						...
						sin personal especializado. Piso PVC resistente a la humedad.
					</p>
				</div>
				<div class="col-md-12 wow fadeInUp align_vertical">
					<span>
		...
		<section class="container aplicaciones mb_60">
			...
			<div class="row">
				...
				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/resistente-aranazos.gif" alt="pisos vinilicos resistentes a los arañazos">
				...
				<div class="col-md-3 text-center">
					<img class="mb_15 wow fadeInUp" src="img/superficies-existentes.gif" alt="pisos vinilicos sobre superficies existentes">
				...
				<div class="row mb_15">
					<div class="col-md-8 offset-md-2 align_vertical_horizontal">
						<div class="transition mail">
							...
							<a id="btn_email" href="#formulario_mobile"><img src="img/mail.png" alt="mail">info@nordeco.com.ar</a>
						</div>
					</div>
				</div>
				<div class="row">
