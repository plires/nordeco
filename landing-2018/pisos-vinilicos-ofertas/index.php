    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form id="formulario_mobile" class="formulario text-left wow fadeIn" method="post">
          ...
          <input name="path" type="hidden" value="pisos-vinilicos-ofertas">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-sm-12 wow fadeIn datos_linea">
          <div class="text-left">
            <img style="width: 20%;" class="header_garantia wow fadeInUp" src="img/sistema-click.png"
              alt="sistema click">
          </div>
  ...
  <section class="container mb_60">
    ...
    <div class="row mb_30">
      <div class="col-md-12 text-center">
        <h2 class="h2_aprovecha wow fadeInUp">Aprovechá esta oferta especial: <br>Pisos Vinilicos de Alto Transito
          <br><span>es por tiempo limitado</span>
        </h2>
