...
$rubro = $_POST["rubro"];
$origin = $_POST["origin"];
$subject = 'Presupuesto Pisos Vinílicos';
...
<title>Contacto de Pisos Vinilicos</title>
<meta charset="utf-8">
...
mail ("$name < $email >", "Su correo ha sido recibido - Pisos Vinilicos",$mensaje,$cabeceras);
?>
