...
$rubro = $_POST["rubro"];
$origin = $_POST["origin"];
$subject = 'Presupuesto Deck Ecológico';
...
<td align="center" style="line-height: 25px;-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 20px 0 0;">
    <img src="http://nordeco.com.ar/landing/img/logo-nordeco.gif" alt="logo nordeco">
                                        ...
                                        <tr>
<td align="center" style="font-size: 25px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #63BCA3; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 10px 0 0;" class="padding-copy">Nordeco - '.$rubro.' TREX</td>
                                        </tr>
                                        <tr>
<td><br><hr><br></td>
                                        </tr>
...
mail ("$name < $email >", "Su correo ha sido recibido - Deck Sintetico TREX",$mensaje,$cabeceras);
?>
