		...
		<section class="container mb_30 formulario_mobile">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<img class="w-100" src="img/deck-header-mobile.jpg">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-7 col-sm-6 text-center">
						<img class="mb_15 header_garantia" src="img/garantia.png" alt="garantia">
					</div>
					<div class="col-lg-5 col-sm-6 text-center">
						<img class="mb_15 header_origen" src="img/origen-eeuu.png" alt="origen eeuu">
					</div>
				</div>
