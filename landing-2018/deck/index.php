	...
	<body>
				...
				<div class="row">
					...
					<div class="col-md-8 align_vertical_horizontal">
						<p class="parrafo_franja_verde wow fadeInUp">
							Los Decks Ecológicos o Decks Sintéticos están fabricados con un 95% de materiales reciclados, desde aserrín hasta envases plásticos.
						</p>
					</div>
		...
		<section class="container mb_30">
			<div class="row">
				...
				<div class="col-md-8 offset-md-2 text-center">
					<h3 class="titulo_linea wow fadeInLeft">DECK ECOLÓGICO - LÍNEA PREMIUM <br><span class="destacado">TRASCEND</span></h3>
					<p class="parrafo_descripcion_linea wow fadeIn">
						Los Decks Sintéticos ofrecen un diseño de vanguardia superior al de otros materiales compuestos, en colores exclusivos y con <strong>profundos vetados propios de la madera.</strong>
					</p>
					<p class="parrafo_descripcion_linea wow fadeIn">
		...
		<section class="container mb_60">
			<div class="row">
				...
				<div class="col-md-8 offset-md-2 text-center">
					<h3 class="titulo_linea wow fadeInLeft">DECK ECOLÓGICO - LÍNEA ESTÁNDAR <br><span class="destacado">CONTOUR</span></h3>
					<p class="parrafo_descripcion_linea wow fadeIn">
