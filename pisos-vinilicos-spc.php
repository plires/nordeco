		...
		<div class="page-wrapper">
			...
			<section class="container">
				<div class="col-sm-12 text-center">
					...
					<h2 class="light">PISOS SPC SISTEMA CLICK</h2>
				</div>
			</section>
			...
			<div class="container">
				<section class="row">
					<div class="col-sm-12">
						<h2>PISOS VINÍLICOS ENCASTRABLES 100% PVC RÍGIDOS</h2>
						<div class="separator-2"></div>
					</div>

					<?php 
						$query = $db->prepare("SELECT * FROM pisos WHERE observaciones LIKE 'click'");
						$query->execute();
