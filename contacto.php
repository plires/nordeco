...
<html lang="es">
	...
	<head>
		...
		<meta name="description" content="pagina de contacto para enterarse de novedades sobre Decks ecologicos, sinteticos,.">
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-8">
							...
							<!-- page-title end -->
							<p>
								Complete los datos del siguiente formulario. Nuestro equipo se pondrá en contacto con usted a la brevedad posible.
							</p>
							...
							<div class="contact-form">
								...
								<form id="contact-form" class="margin-clear" role="form" action="php/email-sender.php">
									...
									<input type="hidden" name="url" value="http://nordeco.com.ar/contacto.php">
							...
							<div class="sidebar">
								<div class="block clearfix">
									...
									<ul class="list">
										...
										<li><i class="fa fa-envelope pr-10"></i><a href="mailto:info@nordeco.com.ar">info@nordeco.com.ar</a></li>
									</ul>
									...
									<div class="col-sm-8 col-sm-offset-2">
										...
										<form method="POST" action="php/newsletter-sender.php" class="form-inline margin-clear">
											<div class="form-group has-feedback">
												...
												<input type="email" class="form-control" id="newsletter" placeholder="Ingresar email" name="newsletter" required="">
