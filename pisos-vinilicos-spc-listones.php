...
<html lang="es">
	...
	<head>
		...
		<meta charset="utf-8">
		<title>Nordeco, pisos vinilicos con sistema para pegar - Listones</title>
		<meta name="description" content="Pisos vinilicos flotantes con sistema para pegar - Listones">
		...
		<div class="page-wrapper">
			...
			<section class="container">
				<div class="col-sm-12 text-center">
					...
					<h2 class="light">PISOS SPC SISTEMA CLICK - LISTONES</h2>
				</div>
			</section>
			...
			<div class="container">
				<section class="row">
					<div class="col-sm-12">
						<h2>PISOS SPC SISTEMA CLICK - 100% PVC RÍGIDOS - LISTONES</h2>
						<div class="separator-2"></div>
					</div>

					<?php 
						$query = $db->prepare("SELECT * FROM pisos WHERE observaciones = 'click' AND linea = 'listones'");
						$query->execute();
